...
namespace MusicGrabber.Modules.Discovery.Application.UseCases.SearchArtists;

public sealed class SearchArtistsHandler(IMusicBrainzApi api) : IMusicBrainzService
{
